...
function setup() {
  ...
  red_balloon = createSprite(47,70,30,20);
  red_balloon.addImage(red_balloonImage)
  red_balloon.scale=0.1
  green_balloon = createSprite(120,40,30,20);
  green_balloon.addImage(green_balloonImage)
  green_balloon.scale=0.1
  pink_balloon = createSprite(270,180,30,20);
  pink_balloon.addImage(pink_balloonImage)
  pink_balloon.scale=1.25
  blue_balloon = createSprite(195,100,30,20);
